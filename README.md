...
Vérification :
Si couleur = 1 ➔ Envoie le message radio "grok\_bleu".
Si couleur = 2 ➔ Envoie le message radio "grok\_jaune".
...
contiens les fonctions de bases de mouvement ainsi qu'un timer interne pour arreter la pamis a 99.5 sec 
